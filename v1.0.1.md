...
- The command-line interface no longer prompts for a password twice when password authentication is used. [#15919](https://github.com/cockroachdb/cockroach/pull/15919)
- `CREATE USER WITH PASSWORD` now works correctly in the `cockroach sql` shell. [#15911](https://github.com/cockroachdb/cockroach/pull/15911)
- Fixed bugs in the `MIN()` and `MAX()` aggregate functions in the presence of `NULL` values. [#15912](https://github.com/cockroachdb/cockroach/pull/15912)
...
- The `--cache` and `--max-sql-memory` flags now use their default values on OpenBSD. [#15914](https://github.com/cockroachdb/cockroach/pull/15914)
- Attempting to create a view involving an array now returns an error instead of crashing the server. [#15913](https://github.com/cockroachdb/cockroach/pull/15913)
- `cockroach start --insecure` now prints a warning about the consequences of insecure mode. [#15924](https://github.com/cockroachdb/cockroach/pull/15924)
...
- Collation locales containing capital letters are now parsed correctly. [#15917](https://github.com/cockroachdb/cockroach/pull/15917)
...
- Dropping a database containing views now works correctly. [#15983](https://github.com/cockroachdb/cockroach/pull/15983)
- Fully-qualified column names referring to views now work correctly. [#15984](https://github.com/cockroachdb/cockroach/pull/15984)
